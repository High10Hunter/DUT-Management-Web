        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('admin.lecturers.update', [
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="genderMale" name="gender" class="custom-control-input"
                                        value="1" @if ($lecturer->gender == 1) checked @endif>
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="genderFemale" name="gender" class="custom-control-input"
                                        value="0" @if ($lecturer->gender == 0) checked @endif>
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="status" id="statusAvailable" class="custom-control-input"
                                        value="1" @if ($lecturer->status == 1) checked @endif>
                                    <label class="custom-control-label" for="statusAvailable">Hoạt động</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="status" id="statusOff" class="custom-control-input"
                                        value="0" @if ($lecturer->status == 0) checked @endif>
                                    <label class="custom-control-label" for="statusOff">Đã nghỉ</label>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mt-3">
                                        ...
                                        <select name="faculty_id" id="faculty-select" class="form-control">
                                            ...
                                            @foreach ($faculties as $faculty)
                                                <option value="{{ $faculty->id }}"
                                                    @if ($lecturer->faculty_id == $faculty->id) selected @endif>
                                                    {{ $faculty->name }}
                                                </option>
                                            @endforeach
                                        </select>
